        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    {if isset($connecteSansNomPrenom)}
                        <li><a href='./interface_util.php'>Bienvenue {$util_email}</a></li>
                        <li class='page-scroll'><a href='deconnexion.php'>Déconnexion</a></li>
                    {elseif isset($connecteAvecNomPrenom)}
                        <li><a href='./interface_util.php'>Bienvenue {$util_nom} {$util_prenom}</a></li>
                        <li class='page-scroll'><a href='deconnexion.php'>Déconnexion</a></li>
                    {else}
